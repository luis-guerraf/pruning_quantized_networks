...
from .binarized_modules import BinarizeLinear, BinarizeConv2d, PrunableBatchNorm2d, PrunableBatchNorm1d
...
class VGG_Cifar10_binary(nn.Module):
    ...
    def __init__(self, num_classes=10):
        ...
        self.classifier = nn.Sequential(
            # Linear layer pruning only works with 1x1xc inputs
            BinarizeLinear(512 * 4 * 4, 1024, bias=True),
            PrunableBatchNorm1d(1024),
            nn.Hardtanh(inplace=True),
